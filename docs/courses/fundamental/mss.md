...
- **[Вариационное исчисление и оптимальное управление]({% link docs/courses/fundamental/optimal_control.md %})**: Вариационное исчислние нужно для решения полевых уравнений 


- **[Дифференциальная геометрия]({% link docs/courses/basic/diff_geom.md %})**: Тензоры напряжения и т.д.


- **[Аналитическая механика]({% link docs/courses/fundamental/analytical_mechanics.md %})**: "Механика"


- **[Уравнения в частных производных]({% link docs/courses/fundamental/pde.md %})**: Уравнения МСС, уравнение Навье-Стокса
