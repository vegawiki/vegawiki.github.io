...
- **[Математическая статистика]({% link statistics.md %})**: Эконометрика -- это набор статистических методов


- **[Линейная алгебра]({% link linear_algebra.md %})**: Буквально начиная с КЛММР необходимо уметь обращаться с матрицами. 
Далее по курсу везде используется линейная алгебра.


- **[Экономика]({% link economics.md %})**: Прикладная эконометрика -- это инструмент анализа, который очень требователен к интуиции и интерпретациям 
